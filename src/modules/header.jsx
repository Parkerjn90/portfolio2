  ...
  return (
    <>
      <Grid container spacing={1} sx={{ flexGrow: 1, margin: "auto", display: "flex", alignItems: "center" }} direction="row">
        ...
        <Grid xs={3}>
          <img className="me" src='https://i.ibb.co/93Bpmjt/Profile-Main.png' alt="self-portrait of Joy Parker" style={{ height: "150px", border: `5px solid ${theme.palette.secondary.main}`, borderRadius: "5px", justifyContent: "right"}} />
        </Grid>
        <Grid xs={2}></Grid>
